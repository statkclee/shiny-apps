...
ui <-shinyUI(fluidPage(
  ...
  mainPanel(
    ...
    tabsetPanel(type = "tabs",
                ...
                tabPanel("표본", br(), br(), plotOutput("sample.dist"), br(), div(h3(textOutput("num.samples")), align ="center")),
                tabPanel( "표집분포", 
                          fluidRow( column(8, br(), br(), 
                                           div(textOutput("CLT.descr"), align = "justify"), br()), 
                                    column(4, br(), plotOutput("pop.dist1", height = "200px"))),
                          plotOutput("sampling.dist") , 
                          div(textOutput("plot.descr"), align = "center"), br())
    )
  )
))
